...
export const DetalhesFilme = async ({ params }: { params: Promise<{ id: number }> }) => {
    const { id } = await params;
        ...
        <>
            <div className={Style.detalhes}>
                <div className={Style.detalhes__container}>
                    ...
                    <section>
                        <figure>
                            <img className={Style.detalhes__image} src={`${process.env.NEXT_PUBLIC_BASE_URL_IMG}${poster_path}`} alt={`Poster do filme ${title}`} />
                        </figure>
